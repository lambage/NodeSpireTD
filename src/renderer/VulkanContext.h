...
public:
    ...
    [[nodiscard]] VkPhysicalDevice physicalDevice() const noexcept { return m_physDevice;      }
    ...
    [[nodiscard]] uint32_t         graphicsFamily() const noexcept { return m_graphicsFamily;  }
    [[nodiscard]] VkRenderPass     renderPass()     const noexcept { return m_renderPass;       }
    [[nodiscard]] VkDescriptorPool imguiPool()      const noexcept { return m_imguiPool;        }
    [[nodiscard]] uint32_t         swapchainImageCount() const noexcept;
    [[nodiscard]] VkExtent2D       swapchainExtent()     const noexcept { return m_swapExtent; }
